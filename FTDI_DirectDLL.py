"""
NOTE: I did not create this file - nor is this an example made for linking DLLs to python. To avoid
confusion it is recommended that you use this DLL wrapper AS IS without modifying it. Basically
all it does is use the SYSTEM installed library form (windows32?) folder by default or the root oft
the project if present.

there are many CTYPES tutorials online for understanding this section.
...
print("Finished Loading FTDI Libs - basic")